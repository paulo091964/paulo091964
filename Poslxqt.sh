...
echo "========================================"
echo " Pós-instalação Debian 13 Lxqt-core   "
echo "========================================"
...
apt install -y xorg lxqt-core lxqt-panel lxqt-session lxqt-config \
  openbox lightdm dbus-x11 gvfs gvfs-backends gvfs-fuse x11-xserver-utils || true
...
apt install -y network-manager network-manager-gnome wpasupplicant 
  firmware-linux firmware-misc-nonfree firmware-realtek || true
...
apt install -y mupdf htop abiword lximage-qt audacious xarchiver rclone \
  falkon claws-mail transmission-qt pavucontrol gkrellm || true
...
apt install -y lxterminal qterminal bash-completion fonts-dejavu-core || true
